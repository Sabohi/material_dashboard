module.exports = {
    ...
    lineChartData:[
    {
        componentData: "SimpleLineChartCard",
        dataKey: "Tickets",
    ...
    [
    {
        componentData: "CustomizedPieChartCard",
    ...
    {
        componentData: "CustomizedPieChartCard",
        chartHeading: "Ticket type Wise Tickets",
        headerBackground: 'secondaryClass4',
    ...
    listData:[
        {
            componentData: "CustomizedListCard",
    ...
    CustomShapeBarChartData:{
        componentData: "CustomShapeBarChartCard",
